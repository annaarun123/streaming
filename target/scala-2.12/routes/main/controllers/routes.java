...
public class routes {
  ...
  public static final controllers.ReverseKafkaStreamController KafkaStreamController = new controllers.ReverseKafkaStreamController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseKafkaStreamController KafkaStreamController = new controllers.javascript.ReverseKafkaStreamController(RoutesPrefix.byNamePrefix());
